...
- **HELIOCENTRIC SOLAR MAP.** A 3D solar system you can drag-orbit and scroll-zoom:
  ...
  - **The NEO orbit web** — every plotted near-Earth object gets a tilted Keplerian
    ellipse (red = potentially hazardous) shedding a clumped debris field; Earth's
    orbit is highlighted blue; the week's closest passes cluster as diamonds at Earth.
